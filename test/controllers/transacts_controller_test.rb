...
class TransactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transact" do
    assert_difference("Transact.count") do
      post transacts_url, params: { transact: { amount: @transact.amount, categories: @transact.categories, category_id: @transact.category_id, name: @transact.name } }
    end
  ...
  test "should update transact" do
    patch transact_url(@transact), params: { transact: { amount: @transact.amount, categories: @transact.categories, category_id: @transact.category_id, name: @transact.name } }
